 ...
 * @author mbustillo
 */
public class CodigoTipoArchivo extends UtilitySolicitudImpl implements handlerResponsabilityInter {

    private handlerResponsabilityInter nextHandlerValidation;

    public CodigoTipoArchivo(handlerResponsabilityInter nextHandlerValidation) {
    ...
    public String validationDataStateInputEspecifyRequest(SolicitudArchivoRequestType getDataEspecifyRequest) {
        ...
        String codeStatus = "";
        if(getDataEspecifyRequest.getCodigoTipoArchivo() == null || getDataEspecifyRequest.getCodigoTipoArchivo().length() == 0 || !comparingStringToRegexAlfaNum(getDataEspecifyRequest.getCodigoTipoArchivo())){
            codeStatus = "0266";
        }else{
